...
console.log(`Loading Session Database....`)
// Loads database.
...
console.log(`Session Database Loaded!`)
...
console.log(`Loaded Database Functions!`)
...
const listener = app.listen(process.env.website.port, function () { // Listens the website at a port.
  console.log(`The DashBoard Is Now Listening On Port ${listener.address().port}.`) // Message sent when the port is successfully listening and the website is ready.
 console.log(`Copyright KoolKid.xyz You are Not Allowed To Resell This Product!`)
